...
WHERE T_Invoices.InvoiceDate BETWEEN %s AND %s '''
                    ...
                    if Party == 0:
                        ...
                        InvoiceQueryresults = T_Invoices.objects.raw(
                            Invoicequery, [FromDate, ToDate, Party])
    ...
    WHERE T_Invoices.InvoiceDate BETWEEN %s AND %s'''
                    ...
                    if Customer == 0:
                        ...
                        InvoiceQueryresults = T_Invoices.objects.raw(
                            Invoicequery, [FromDate, ToDate, Customer])
