        ...
        try:
            with transaction.atomic():
                ...
                if M_Parties_Serializer.is_valid():
                    ...
                    log_entry = create_transaction_logNew(request, party_data, party_data['PartySubParty'][0]['Party'], '', 92, LastInsertID )
        ...
        try:
            with transaction.atomic():
                ...
                if M_Parties_Serializer.is_valid():
                    ...
                    log_entry = create_transaction_logNew(request, party_data, id, '', 94, id)
