        ...
        try:
            with transaction.atomic():
                ...
                GRNListData.append({
                    ...
                    "CustomerStateID" : a['Customer']['State'],
                    "CustomerState": a['Customer'].get('PartyState', {}).get('Name', ""),
                    "CustomerMobileNo" : a['Customer']['MobileNo'],
                    "CustomerAddress": a['Customer']['PartyAddress'][0]['Address'] if a['Customer']['PartyAddress'] else "",
                    "CustomerFSSAINo": a['Customer']['PartyAddress'][0]['FSSAINo'] if a['Customer']['PartyAddress'] else "",
                    ...
                    "PartyStateID" : a['Party']['State'],
                    "PartyState": a['Party'].get('PartyState', {}).get('Name', ""),
                    "PartyMobileNo" : a['Party']['MobileNo'],
                    "PartyAddress": a['Party']['PartyAddress'][0]['Address'] if a['Party']['PartyAddress'] else "",
                    "PartyFSSAINo": a['Party']['PartyAddress'][0]['FSSAINo'] if a['Party']['PartyAddress'] else "",
