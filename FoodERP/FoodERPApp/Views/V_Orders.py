            ...
            with transaction.atomic():
                ...
                if(OrderType == 3):  # OrderType - 3 for GRN STP Showing Invoices for Making GRN
                    if(Supplier == ''):
                        ...
                        query = T_Invoices.objects.filter(Customer_id=Customer, Party=Supplier)
