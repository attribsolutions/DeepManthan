    ...
    def delete(self, request, id=0):
        try:
            with transaction.atomic():
                ...
                new_row3 = DeletedTC_InvoicesReferences(Invoice=row3[0]['Invoice'],Order=row3[0]['Order'])
                new_row3.save()                                                                                                                                                                                                                                                           
