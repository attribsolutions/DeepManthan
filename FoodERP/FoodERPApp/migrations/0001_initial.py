# Generated by Django 3.0.8 on 2023-03-09 10:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UpdatedBy', models.IntegerField()),
                ('UpdatedOn', models.DateTimeField(auto_now=True)),
                ('Driver', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='DriverName', to='FoodERPApp.M_Drivers')),
            ],
            options={
                'db_table': 'M_Vehicles',
            },
