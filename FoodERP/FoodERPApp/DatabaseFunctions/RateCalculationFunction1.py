...
BEGIN
    ...
    declare Rate decimal(20, 10);
		...
		SELECT GetTodaysDateMRP(ItemID,CURDATE(),2,0,0)MRPValue,GSTHsnCodeMaster(ItemID,CURDATE(),2)GSTPercentage into MRPValuee, GSTPercentagee   from M_Items where id=ItemID;
