...
class T_GRNSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = T_GRNs
        fields = ['GRNDate', 'Customer', 'GRNNumber', 'FullGRNNumber','InvoiceNumber','InvoiceDate','GrandTotal', 'Party', 'CreatedBy', 'UpdatedBy', 'GRNItems','O_LiveBatchesList','GRNReferences']
