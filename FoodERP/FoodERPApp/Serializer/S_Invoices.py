...
class InvoiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = T_Invoices
        fields = ['id','InvoiceDate', 'InvoiceNumber', 'FullInvoiceNumber', 'GrandTotal', 'RoundOffAmount', 'CreatedBy', 'UpdatedBy', 'Customer', 'Party','Vehicle_id','Driver_id', 'InvoiceItems', 'InvoicesReferences', 'obatchwiseStock','TCSAmount']
