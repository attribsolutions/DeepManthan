...
from rest_framework.authentication import get_authorization_header, BasicAuthentication, TokenAuthentication
...
class SweetPOSUsersSecondView(CreateAPIView):
    ...
    def authenticate_user(self, request):
        ...
        if auth_header[0].lower() == b'basic':
            return BasicAuthentication().authenticate(request)
        elif auth_header[0].lower() == b'Token':
