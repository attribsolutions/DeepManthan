            ...
            with transaction.atomic():
                ...
                if user is not None: 
                    ...
                    if not QueryfordivisionID:
                        ...
                        QueryForMaxSalesID=T_SPOSInvoices.objects.raw('''SELECT 1 id,max(SaleID) MaxSaleID FROM SweetPOS.T_SPOSInvoices where Party=%s and clientID=%s''', [QueryfordivisionID[0]['Party'] ,ClientID])
