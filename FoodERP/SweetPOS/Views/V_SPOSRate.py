    ...
    def post(self, request):
        ...
        try:
            with transaction.atomic():
                ...
                M_SPOSRateMaster.objects.filter(ItemID__in=item_ids, IsDeleted=0, POSRateType=Rate_data[0]['POSRateType'],EffectiveFrom__lte=Rate_data[0]['EffectiveFrom']).update(IsDeleted=1)
