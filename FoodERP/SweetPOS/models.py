...
class TC_SPOSInvoiceItems(models.Model):
    ...
    Quantity = models.DecimalField(max_digits=40, decimal_places=10)
    BaseUnitQuantity = models.DecimalField(max_digits=40, decimal_places=10)
    MRPValue =  models.DecimalField(max_digits=20, decimal_places=2,null=True,blank=True)
    Rate = models.DecimalField(max_digits=40, decimal_places=10)
    BasicAmount = models.DecimalField(max_digits=40, decimal_places=10)
    TaxType = models.CharField(max_length=500)
    GSTPercentage = models.DecimalField(max_digits=40, decimal_places=10)
    GSTAmount = models.DecimalField(max_digits=40, decimal_places=10)
    ...
    Discount = models.DecimalField(max_digits=40, decimal_places=10,blank=True, null=True)
    DiscountAmount = models.DecimalField(max_digits=40, decimal_places=10,blank=True, null=True)
    CGST = models.DecimalField(max_digits=40, decimal_places=10)
    SGST = models.DecimalField(max_digits=40, decimal_places=10)
    IGST = models.DecimalField(max_digits=40, decimal_places=10)
    CGSTPercentage = models.DecimalField(max_digits=40, decimal_places=10)
    SGSTPercentage = models.DecimalField(max_digits=40, decimal_places=10)
    IGSTPercentage = models.DecimalField(max_digits=40, decimal_places=10)
