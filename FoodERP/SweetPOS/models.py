...
class TC_SPOSInvoiceItems(models.Model):
    ...
    GSTPercentage = models.DecimalField(max_digits=60, decimal_places=20)
    GSTAmount = models.DecimalField(max_digits=60, decimal_places=20)
    Amount = models.DecimalField(max_digits=60, decimal_places=20)
    DiscountType = models.CharField(max_length=10,blank=True, null=True)
    Discount = models.DecimalField(max_digits=60, decimal_places=20,blank=True, null=True)
    DiscountAmount = models.DecimalField(max_digits=60, decimal_places=20,blank=True, null=True)
    CGST = models.DecimalField(max_digits=60, decimal_places=20)
    SGST = models.DecimalField(max_digits=60, decimal_places=20)
    IGST = models.DecimalField(max_digits=60, decimal_places=20)
    CGSTPercentage = models.DecimalField(max_digits=60, decimal_places=20)
    SGSTPercentage = models.DecimalField(max_digits=60, decimal_places=20)
    IGSTPercentage = models.DecimalField(max_digits=60, decimal_places=20)
